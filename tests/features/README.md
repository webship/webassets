...
| `02-01-01-webassets-module-enabled.feature` | Web Assets module + Media / Library / Responsive Image / Layout Builder / Crop / Focal Point / Remote Audio are enabled. |
| `02-02-01-media-types-installed.feature` | All six media types (Audio, Document, Image, Remote audio, Remote video, Video) and their edit forms. |
...
| `03-01-01-media-add-image.feature` | Add Image form + the `/media/add` chooser lists all six bundles. |
